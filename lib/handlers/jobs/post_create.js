  ...
  if (!request.auth.isAuthenticated) {
    ...
    listUsers(function (errUsers, users) {
      ...
      if (request.payload.id) {
        ...
        //add stagesAllowed by default the property contains all the ids of the stage

        listStages(function(error, stages){

          jobObj.stagesAllowed = stages.map(function(stage){
