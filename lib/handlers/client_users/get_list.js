...
module.exports = (request, reply) => {
  ...
  clientUsersList((err, clientUsers) => {
    ...
    listClients((errClients, clients) => {
      ...
      const inauthorizedClients = clientUsers.filter ( clientUser => !clientUser.authorized );

      return reply.view('clientUsers', {clientUsers: clientUsers, authorizedClients: authorizedClients, inauthorizedClients: inauthorizedClients });
    });
  });
}
