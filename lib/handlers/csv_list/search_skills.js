...
module.exports = function (request, reply) {
  ...
  */
  ...
  const page_url_prev = '/query-list/' + encodeURIComponent(request.params.listName) + '/' + (pageNumber) + '?skills=' + encodeURIComponent(request.query.skills);
  const page_url_next = '/query-list/' + encodeURIComponent(request.params.listName) + '/' + (pageNumber + 2) + '?skills=' + encodeURIComponent(request.query.skills);
