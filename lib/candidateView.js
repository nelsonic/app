...
var listClients = require('./database-helpers/elasticsearch/list_clients');
          ...
          es.get({
            ...
            if(listFavourite.indexOf(myId) !== -1) {
              ...
              multigetJobs(idsJob, function(errJobs, jobs) {
                ...
                const statusHistory = response._source.statusHistory || [];
                ...
                getBlacklistCompanies(function(error, clientList){
                  ...
                  jobList(function (errJobs, jobs) {
                    ...
                    listClients(function (errClients, clients) {
                      ...
                      return reply.view('candidateView', {candidate: response._source, jobs: jobs, clients: clients});
                    });
                  });
                });
              })
