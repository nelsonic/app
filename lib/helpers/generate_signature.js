...
var signature = "";
  ...
  signature += '<span style="font-size:14pt"><font face="arial, helvetica, sans-serif"><font color="#999999">' + user.names.fullname + '</font><br></font></span>'
  ...
  signature += '<span style="color:rgb(153,153,153);font-size:9.5pt;font-family:Arial,sans-serif">:' + user.phones.office + '&nbsp;</span>'
  signature += '<b><span style="font-size:9.5pt;font-family:Arial,sans-serif"><font color="#93c47d">m</font></span></b>'
  signature += '<span style="font-size:9.5pt;font-family:Arial,sans-serif"><font color="#999999">:' + user.phones.mobile + '<br></font>'
  signature += '<br>'
